...
const adminNav: NavItem[] = [
  ...
  { href: "/admin/catalog", label: "Kampanya Yönetimi", icon: Megaphone },
  ...
  { href: "/admin/requests", label: "Ürün / Değişim Talepleri", icon: ClipboardList },
  { href: "/admin/campaign-requests", label: "Kampanya Talepleri", icon: Megaphone },
...
const storeNav: NavItem[] = [
  ...
  { href: "/store/products", label: "Ürün Talepleri", icon: Package },
  { href: "/store/catalog", label: "Kampanya Talepleri", icon: Megaphone },
