...
export const STORE_MENU: MenuItem[] = [
  ...
  { href: "/store/products", label: "Ürün Talepleri" },
  { href: "/store/catalog", label: "Kampanya Talepleri" },
...
export const ADMIN_MENU: MenuItem[] = [
  ...
  { href: "/admin/products", label: "Ürün Kataloğu" },
  { href: "/admin/catalog", label: "Kampanya Yönetimi" },
  ...
  { href: "/admin/requests", label: "Ürün / Değişim Talepleri" },
